...
public class Announceedit22 extends AppCompatActivity {
...
//        });
        ...
        btn_Ann.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Announceedit22.this,"수정하였습니다.", Toast.LENGTH_SHORT).show();
//
    ...
    private void init() {
        ...
        findViewById(R.id.tv_Date).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Announceedit22.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker datePicker, int year, int month, int date) {

                        String msg = String.format("%d 년 %d 월 %d 일", year, month + 1, date);
                        makeText(Announceedit22.this, msg, LENGTH_SHORT).show();
